    ...
    return rx.el.dialog(
        rx.el.div(
            ...
            rx.el.input(
                ...
                class_name="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mb-4",
            ...
            rx.el.div(
                rx.el.button(
                    ...
                    class_name="mr-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-transparent rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
                ),
                rx.el.button(
                    "Ajouter",
                    on_click=GptaState.add_new_organ,
                    class_name="px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
                ),
...
def add_failure_log_modal() -> rx.Component:
    return rx.el.dialog(
        rx.el.div(
            ...
            rx.el.form(
                rx.el.div(
                    ...
                    rx.el.select(
                        ...
                        name="organ_name",
                        class_name="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm",
                        required=True,
                    ),
                    class_name="mb-4",
                ),
                ...
                rx.el.div(
                    rx.el.label(
                        "Temps de fonctionnement depuis dernière panne (heures):",
                        class_name="block text-sm font-medium text-gray-700",
                    ),
                    rx.el.input(
                        type="number",
            ...
            class_name="bg-white p-6 rounded-lg shadow-xl w-full max-w-lg",
        ),
